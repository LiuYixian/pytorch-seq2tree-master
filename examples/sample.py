...
from seq2seq.dataset import SourceField, TargetField, CompField, NTField, TreeField
...
if opt.load_checkpoint is not None:
    ...
    output_vocab.load_vectors(['glove.840B.300d'])
    ...
    output_vocab.vectors[output_vocab.stoi['<unk>']] = torch.Tensor(hidden_size).uniform_(-0.8,0.8)#<pad>
